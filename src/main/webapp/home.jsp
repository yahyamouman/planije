		                ...
		                <div class="col-md-12">
		                    <div class="col-md-12">
		                        <h5 class="">
		                            ...
		                            <small class="text-muted">Less than 3 days until deadline :</small></h5>
		                    </div>
		
		                </div>
						
		                <!-- Danger Cards -->
		                <c:if test="${dangerTasks.isEmpty()}">
							You don't have any urgent tasks
						</c:if>
		                
		                <c:forEach items="${dangerTasks}" var="task">
		            ...
		            <div class="row">
		                ...
		                <div class="col-md-12">
		                    <div class="col-md-12">
		                        <h5 class="">
		                            <i class="nc-icon nc-chat-33"></i>
		                            <small class="text-muted">Less than 7 days until deadline :</small></h5>
		                    </div>
		
		                </div>
						
		                <!-- Danger Cards -->
		                <c:if test="${warningTasks.isEmpty()}">
							You don't have any urgent tasks
						</c:if>
		                
		                <c:forEach items="${warningTasks}" var="task">
							<div class="col-lg-4 col-md-6 col-sm-6">
							   <div class="card card-stats">
							      <div class="card-header">
							         <div class="row">
					...
					<div class="row">
		                ...
		                <div class="col-md-12">
		                    <div class="col-md-12">
		                        <h5 class="">
		                            <i class="nc-icon nc-chat-33"></i>
		                            <small class="text-muted">Later :</small></h5>
		                    </div>
		
		                </div>
						
		                <!-- Danger Cards -->
		                <c:if test="${otherTasks.isEmpty()}">
							Add more tasks
						</c:if>
		                
		                <c:forEach items="${otherTasks}" var="task">
							<div class="col-lg-4 col-md-6 col-sm-6">
							   <div class="card card-stats">
							      <div class="card-header">
							         <div class="row">
